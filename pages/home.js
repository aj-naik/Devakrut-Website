        ...
        <>
            ...
            <div className="process-section">
                ...
                <AnimatedOnScroll animationIn="fadeIn" animationOut="" animationInDuration={1200}>
                    <div className="process_title formatter">
                        <Image
                            src={process_title_home}
                            alt="process title"
                        />
                    </div>
                </AnimatedOnScroll>
                <AnimatedOnScroll animationIn="fadeInLeft" animationOut="" animationInDuration={1200}>
                    <div className="process_1 formatter">
                        <Image
                            src={process_1_image}
                            alt="process1"
                        />
                ...
                <AnimatedOnScroll animationIn="fadeInRight" animationOut="" animationInDuration={1200}>
                    <div className="process_2 formatter">
                        <Image
                            src={process_2_image}
                            alt="process2"
                        />
                ...
                <AnimatedOnScroll animationIn="fadeInLeft" animationOut="" animationInDuration={1200}>
                    <div className="process_3 formatter">
                        <Image
                            src={process_3_image}
                            alt="process3"
                        />
                ...
                <AnimatedOnScroll animationIn="fadeInRight" animationOut="" animationInDuration={1200}>
                    <div className="process_4 formatter">
                        <Image
                            src={process_4_image}
                            alt="process4"
                        />
            ...
            <div className="benefits-section">
                <AnimatedOnScroll animationIn="fadeInRight" animationOut="" animationInDuration={1200}>
                    <div className="benefits-title-home formatter">
                        <Image
                            src={benefits_title_home}
                            alt="benefits title"
                        />
                    </div>
                </AnimatedOnScroll>
